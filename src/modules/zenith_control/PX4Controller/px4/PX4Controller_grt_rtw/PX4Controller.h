...
struct B_PX4Controller_T {
  real_T steErr;                       /* '<S51>/Sum' */
  real_T VectorConcatenate[6];         /* '<S12>/Vector Concatenate' */
  real_T Gain[6];                      /* '<S14>/Gain' */
  real_T Switch1[4];                   /* '<S10>/Switch1' */
  real_T Switch2[6];                   /* '<S10>/Switch2' */
  real_T Switch3[2];                   /* '<S10>/Switch3' */
  real_T Switch4[2];                   /* '<S10>/Switch4' */
  real_T Gain5[2];                     /* '<S3>/Gain5' */
  real_T Product[2];                   /* '<S35>/Product' */
  real_T Product_g;                    /* '<S54>/Product' */
  real_T steDotErr;                    /* '<S51>/Sum1' */
  boolean_T OR;                        /* '<S47>/OR' */
  boolean_T OR_i;                      /* '<S26>/OR' */
};
...
struct DW_PX4Controller_T {
  ...
  uint32_T Prelookup4_DWORK1;          /* '<S7>/Prelookup4' */
  uint32_T Prelookup6_DWORK1;          /* '<S7>/Prelookup6' */
  uint32_T Prelookup1_DWORK1;          /* '<S7>/Prelookup1' */
  uint32_T Prelookup2_DWORK1;          /* '<S7>/Prelookup2' */
  uint32_T Prelookup3_DWORK1;          /* '<S7>/Prelookup3' */
};

/* Continuous states (default storage) */
struct X_PX4Controller_T {
  real_T Integrator_CSTATE;            /* '<S52>/Integrator' */
  real_T Integrator_CSTATE_c[2];       /* '<S29>/Integrator' */
  real_T TransferFcn1_CSTATE;          /* '<S3>/Transfer Fcn1' */
  real_T TransferFcn_CSTATE;           /* '<S3>/Transfer Fcn' */
  real_T Lowpass_CSTATE;               /* '<S51>/Low pass' */
  real_T Integrator_CSTATE_ca;         /* '<S56>/Integrator' */
};
...
struct XDis_PX4Controller_T {
  ...
  boolean_T Integrator_CSTATE_c[2];    /* '<S29>/Integrator' */
  boolean_T TransferFcn1_CSTATE;       /* '<S3>/Transfer Fcn1' */
  boolean_T TransferFcn_CSTATE;        /* '<S3>/Transfer Fcn' */
  boolean_T Lowpass_CSTATE;            /* '<S51>/Low pass' */
  boolean_T Integrator_CSTATE_ca;      /* '<S56>/Integrator' */
};

/* Zero-crossing (trigger) state */
struct PrevZCX_PX4Controller_T {
  ZCSigState Integrator_Reset_ZCE;     /* '<S52>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_f;   /* '<S29>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_m;   /* '<S56>/Integrator' */
};
...
struct P_PX4Controller_T_ {
  ...
  real_T InterpolationUsingPrelookup_T_c[4];/* Expression: squeeze(table)
                                             * Referenced by: '<S58>/Interpolation Using Prelookup'
                                             */
  ...
  real_T Gain3_Gain;                   /* Expression: 5
                                        ...
                                        */
  real_T InterpolationUsingPrelookup_T_g[12];/* Expression: squeeze(table)
  ...
  real_T InterpolationUsingPrelookup__cs[12];/* Expression: squeeze(table)
                                              * Referenced by: '<S46>/Interpolation Using Prelookup'
                                              */
  ...
  real_T Saturation_LowerSat_d[3];     /* Expression: -config.gains.rate.max
                                        * Referenced by: '<S6>/Saturation'
                                        */
  real_T InterpolationUsingPrelookup_T_f[12];/* Expression: squeeze(table)
                                              * Referenced by: '<S44>/Interpolation Using Prelookup'
                                              */
  real_T enabled_Gain;                 /* Computed Parameter: enabled_Gain
                                        * Referenced by: '<S6>/  enabled '
                                        */
  ...
  real_T Multiply4_Gain;               /* Expression: config.gains.tecs.G
                                        * Referenced by: '<S49>/Multiply4'
                                        */
  real_T Gain5_Gain_g;                 /* Computed Parameter: Gain5_Gain_g
  ...
  real_T InterpolationUsingPrelookup_T_b[4];/* Expression: squeeze(table)
                                             * Referenced by: '<S53>/Interpolation Using Prelookup'
                                             */
  ...
  real_T Saturation1_LowerSat_k[2];
                                   ...
                                   * Referenced by: '<S3>/Saturation1'
                                   */
  real_T Constant_Value_o[2];          /* Expression: 0:size(table, 4) - 1
                                        * Referenced by: '<S33>/Constant'
                                        */
  real_T InterpolationUsingPrelookup__jh[8];/* Expression: squeeze(table)
                                             * Referenced by: '<S33>/Interpolation Using Prelookup'
                                             */
  real_T Integrator_IC_m;              /* Expression: 0
                                        * Referenced by: '<S29>/Integrator'
                                        */
  real_T Constant_Value_b[2];          /* Expression: 0:size(table, 4) - 1
  ...
  real_T InterpolationUsingPrelookup_T_l[8];/* Expression: squeeze(table)
                                             ...
                                             */
  real_T Gain1_Gain_ef;                /* Expression: config.gains.tecs.G
  ...
  real_T Gain6_Gain_m;                 /* Expression: 0
                                        ...
                                        */
  real_T enabled_Gain_n;               /* Computed Parameter: enabled_Gain_n
                                        * Referenced by: '<S3>/ enabled  '
                                        */
  real_T Switch7_Threshold_k;          /* Expression: 0
                                        * Referenced by: '<S42>/Switch7'
                                        */
  ...
  real_T Switch2_Threshold_l;          /* Expression: 0
                                        ...
                                        */
  real_T Constant_Value_j[3];          /* Expression: 0:size(table, 4) - 1
                                        * Referenced by: '<S44>/Constant'
                                        */
  real_T Constant_Value_f[3];          /* Expression: 0:size(table, 4) - 1
                                        * Referenced by: '<S46>/Constant'
                                        */
  real_T Constant_Value_m[3];          /* Expression: 0:size(table, 4) - 1
                                        * Referenced by: '<S45>/Constant'
                                        */
  real_T Switch7_Threshold_e;          /* Expression: 0
                                        * Referenced by: '<S11>/Switch7'
                                        */
  real_T Lowpass_A;                    /* Computed Parameter: Lowpass_A
                                        * Referenced by: '<S51>/Low pass'
                                        */
  ...
  real_T Constant_Value_e[4];          /* Expression: 0:size(table, 4) - 1
                                        ...
                                        */
  real_T Constant_Value_mc[6];         /* Expression: 0:size(table, 4) - 1
  ...
  real_T Memory_4_InitialCondition;    /* Expression: 0
                                        * Referenced by: '<S1>/Memory'
                                        */
  real_T Constant_Value_js[4];         /* Expression: [1 1 1 1]
  ...
  real_T InterpolationUsingPrelookup__mw[4];/* Expression: squeeze(table)
                                             * Referenced by: '<S54>/Interpolation Using Prelookup'
                                             */
 ...
 * '<S5>'   : 'PX4Controller/Controller/L1'
 * '<S6>'   : 'PX4Controller/Controller/Rate'
 * '<S7>'   : 'PX4Controller/Controller/SchedBus'
 * '<S8>'   : 'PX4Controller/Controller/TECS'
 * '<S9>'   : 'PX4Controller/Controller/Allocation/ Trim'
 * '<S10>'  : 'PX4Controller/Controller/Allocation/Actuation override'
 * '<S11>'  : 'PX4Controller/Controller/Allocation/FM Override'
 * '<S12>'  : 'PX4Controller/Controller/Allocation/FMCmd'
 ...
 * '<S17>'  : 'PX4Controller/Controller/Allocation/Subsystem Reference3'
 * '<S18>'  : 'PX4Controller/Controller/Allocation/ Trim/Subsystem Reference3'
 * '<S19>'  : 'PX4Controller/Controller/Allocation/ Trim/Subsystem Reference4'
 * '<S20>'  : 'PX4Controller/Controller/Allocation/ Trim/Subsystem Reference5'
 * '<S21>'  : 'PX4Controller/Controller/Allocation/ Trim/Subsystem Reference6'
 * '<S22>'  : 'PX4Controller/Controller/Allocation/Subsystem/Subsystem Reference1'
 * '<S23>'  : 'PX4Controller/Controller/Allocation/Subsystem/Subsystem Reference2'
 * '<S24>'  : 'PX4Controller/Controller/Allocation/Subsystem/Subsystem Reference3'
 * '<S25>'  : 'PX4Controller/Controller/Attitude/Manual override'
 * '<S26>'  : 'PX4Controller/Controller/Attitude/Reset'
 * '<S27>'  : 'PX4Controller/Controller/Attitude/Saturation'
 * '<S28>'  : 'PX4Controller/Controller/Attitude/Signals'
 * '<S29>'  : 'PX4Controller/Controller/Attitude/Subsystem'
 ...
 * '<S33>'  : 'PX4Controller/Controller/Attitude/attitude.FF'
 ...
 * '<S37>'  : 'PX4Controller/Controller/L1/Controller'
 * '<S38>'  : 'PX4Controller/Controller/L1/L1'
 * '<S39>'  : 'PX4Controller/Controller/L1/Line'
 * '<S40>'  : 'PX4Controller/Controller/L1/Saturation'
 * '<S41>'  : 'PX4Controller/Controller/L1/L1/gains.L1.wnInv'
 * '<S42>'  : 'PX4Controller/Controller/Rate/Manual override'
 * '<S43>'  : 'PX4Controller/Controller/Rate/Subsystem Reference3'
 * '<S44>'  : 'PX4Controller/Controller/Rate/rate.FF'
 * '<S45>'  : 'PX4Controller/Controller/Rate/rate.Kd'
 * '<S46>'  : 'PX4Controller/Controller/Rate/rate.Kp'
 * '<S47>'  : 'PX4Controller/Controller/TECS/Reset'
 * '<S48>'  : 'PX4Controller/Controller/TECS/Saturation'
 * '<S49>'  : 'PX4Controller/Controller/TECS/Specific energy '
 * '<S50>'  : 'PX4Controller/Controller/TECS/Specific energy balance'
 * '<S51>'  : 'PX4Controller/Controller/TECS/Total specific energy'
 * '<S52>'  : 'PX4Controller/Controller/TECS/Specific energy balance/Subsystem'
 * '<S53>'  : 'PX4Controller/Controller/TECS/Specific energy balance/tecs.balKd'
 * '<S54>'  : 'PX4Controller/Controller/TECS/Specific energy balance/tecs.balKi'
 * '<S55>'  : 'PX4Controller/Controller/TECS/Specific energy balance/tecs.balKp'
 * '<S56>'  : 'PX4Controller/Controller/TECS/Total specific energy/Subsystem'
 * '<S57>'  : 'PX4Controller/Controller/TECS/Total specific energy/gains.tecs.totKi'
 * '<S58>'  : 'PX4Controller/Controller/TECS/Total specific energy/tecs.totKd'
 * '<S59>'  : 'PX4Controller/Controller/TECS/Total specific energy/tecs.totKp'
 */
